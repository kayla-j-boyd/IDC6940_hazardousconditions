...
The model comparison confirms our findings and subsequent refining of the model to achieve the best fit. Variables that did not meet assumption for proportional hazards were excluded as well as variables that were found to be non-significant.
